...
module.exports = {
  ...
  devServer: {
    static: {
      directory: path.resolve(__dirname, "public"), // где у тебя лежат статические файлы (если есть)
      watch: true,
    },
    hot: true, // Включите горячую замену модулей
    liveReload: true, // Включите автоматическую перезагрузку
    watchFiles: ["src/**/*"], // Укажите файлы для наблюдения
